...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponce> resoueceNotFoundExceptionHandler(ResourceNotFoundException ex){
    ...
    public ResponseEntity<ApiResponce> handelApiExeption( ApiException ex){
        String message= ex.getMessage();
